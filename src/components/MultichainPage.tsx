...
import { Link } from "react-router-dom"; // react-router-dom için Link'i kullanıyoruz
import { arbitrumSepolia, baseSepolia } from "thirdweb/chains";
import { ThirdwebContract, getContract } from "thirdweb";

interface MultichainPageProps { }

const MultichainPage: React.FC<MultichainPageProps> = () => {
    const smartAccount = useActiveAccount();

    return (
        <div className="flex flex-col items-center mt-20">
            <h1 className="text-center text-2xl md:text-6xl font-semibold md:font-bold tracking-tighter mb-12 text-black">
                Multichain
                <br />
